...
func (t *Tool) Description() string {
	return "Read exact text file contents, a 1-based line range, or file metadata plus file_id and SHA-256 metadata. Use before edit_file when you need exact text. Relative paths resolve from the current working directory; absolute paths are allowed. Auto mode may omit unchanged full-file content already returned."
}
